...
function CityRankPageInner({ user }) {
      ...
      <div className="container mx-auto px-8 py-6">
        <div className="mb-8 pt-3 text-left">
          ...
          <p className="text-muted-foreground mt-1">
            Discover cities through community rankings, ratings, and hidden
            stories.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {filteredCities.map((city, index) => (
                <div
                  ...
                  onClick={() =>
                    router.push(`/workspace/city-rank/${city.slug}`)
                  }
                >
                  <div className="relative">
                    <img
...
export default function CityRankPage() {
  return <User>{(user) => <CityRankPageInner user={user} />}</User>;
}
