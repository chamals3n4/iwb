...
import { Search, ArrowRight, MessageCircle, X, Loader2 } from "lucide-react";
import { Input } from "@/components/ui/input";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";
import { User } from "@asgardeo/nextjs";

function AIChatInterfaceInner({ user }) {
                ...
                <div className="space-y-4">
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-500">
                      Ask me about cities, attractions, travel tips, and more!
                    </p>
                  </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex space-x-2">
                        <Input
                          ...
                          onKeyPress={(e) =>
                            e.key === "Enter" && handleFollowUpSearch()
                          }
                          disabled={isLoading}
                        />
                        <Button
...
export default function AIChatInterface() {
  return <User>{(user) => <AIChatInterfaceInner user={user} />}</User>;
}
